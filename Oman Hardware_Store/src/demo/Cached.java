 ...
 * @author Jasper Potts
 */
public class Cached extends Transition {
     ...
     */
    public Cached(final Node node, final Timeline timeline) {
     ...
     */
    public Cached(final Node node, final Timeline timeline, final boolean useCache) {
        this.node = node;
        this.timeline = timeline;
        this.useCache = useCache;
        statusProperty().addListener(new ChangeListener<Animation.Status>() {
            @Override public void changed(ObservableValue<? extends Animation.Status> ov, Animation.Status t, Animation.Status newStatus) {
                switch(newStatus) {
                    case RUNNING:
                        starting();
                        break;
